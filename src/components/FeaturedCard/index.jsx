...
import Button from '../Button';  // Corrigido para caminho relativo correto
import Discount from '../Discount';  // Corrigido para caminho relativo correto

const FeaturedCard = ({ title, discount, image }) => {
  return (
